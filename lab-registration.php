...
<head>
    ...
    <title>LabAssistant-Registration - HTML5 </title>
    <meta name="description" content="Registration - HTML5 ">
                ...
                <div class="login-form">
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Enter your Lab Number" name="lab_number">
                        </div>
                        <div class="checkbox">
                            <label>
