...
<head>
    ...
    <title>DPO Page</title>
    <meta name="description" content="DPO-PAGE">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children">
                        <a href="#"> <i class="menu-icon fa fa-bell"></i>Pending Approval</a>

                    </li>
                    <li class="menu-item-has-children">
                        <a href="#"> <i class="menu-icon fa fa-check"></i>Approved Assets</a>
            ...
            <div class="col-md-4">
                <div class="card text-white bg-flat-color-5">
                    <div class="card-body pb-0">
                        ...
                        <p class="text-light"><strong>Approved Assets</strong></p>
